#!/usr/bin/env python3
"""
Enhanced Excel Data Cleaner with Multi-LLM Pipeline - LOCAL VERSION
Features:
...
Configuration:
- Uses dotenv for local development (.env file)
...
# Set page config
st.set_page_config(
    page_title="Excel Data Cleaner - Multi-LLM Pipeline (LOCAL)",
    page_icon="🧹",
    layout="wide"
)
...
# Main App
st.markdown('<h1 class="main-header">🧹 Excel Data Cleaner - Multi-LLM Pipeline (LOCAL)</h1>', unsafe_allow_html=True)

# Sidebar
with st.sidebar:
    st.markdown("### ⚙️ Configuration")
    st.info("Using LOCAL configuration (.env file)")
...
with col1:
    st.markdown("🧹 Excel Data Cleaner - Multi-LLM Pipeline (LOCAL VERSION) | Powered by AI")
with col2:
